...
parser.add_argument('-in','--in', help='Input  spectra. This is a 2D in-phase Ct-Cp \
                    spectra with the 13Ct dimension in the time domain. The 13Ct dimension \
                    should be phased but the imaginary part retained and should not be \
                    apodized, zero-filled or Fourier transformed. \
                    The 13Cp dimension should be apodized, zero-filled, phased \
                    (the imaginary part deleted) then Fourier transformed. \
                    The order of the input dimensions must be 13Cp, 13Ct.', required=True)
